...
namespace WidePictBoard.Tests.Comment
{
    public partial class CommentServiceV1Test
    {
        ...
        {
            // Arrange
            ConfigureMoqForRestoreMethod(userId.ToString(), commentId);

            // Act
            await _commentServiceV1.Restore(request, cancellationToken);
        ...
        private void ConfigureMoqForRestoreMethod(string userId, int commentId)
        {
